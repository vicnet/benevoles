...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/Benevoles.st', // list all sources in dependency order
                    'src/Benevoles-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-benevoles',
                libraries: ['SUnit', 'Web']
            },
            test_runner: {
                ...
                libraries: [
                    ...
                    'Benevoles', /* add other code-to-test packages here */
                    'SUnit',
                    'Benevoles-Tests' /* add other test packages here */
                ],
